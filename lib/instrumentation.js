...
'use strict'
const storeDbName = Symbol('storeDatabase')
const dbName = Symbol('databaseName')
...
function getInstanceParameters(shim, queryable, query) {
  ...
  let databaseName = queryable[dbName] || null
  if (conf) {
